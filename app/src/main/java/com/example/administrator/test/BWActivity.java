...
public class BWActivity extends  AppCompatActivity implements OnScrollListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addNote.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                BWTJActivity.ENTER_STATE = 0;
                Intent intent = new Intent(mContext, BWTJActivity.class);
    ...
    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
        ...
        while (c.moveToNext()) {
            ...
            BWTJActivity.id = Integer.parseInt(No);
            myIntent.putExtras(bundle);
            myIntent.setClass(BWActivity.this, BWTJActivity.class);
